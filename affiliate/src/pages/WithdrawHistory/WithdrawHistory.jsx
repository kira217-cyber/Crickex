...
const inputCls =
  "w-full rounded-2xl border border-white/10 bg-black/35 px-4 py-3 text-sm text-white outline-none transition focus:border-[#1A79D3]/60 focus:shadow-[0_0_25px_rgba(26,121,211,0.20)]";
      ...
      <div className="relative z-10 mx-auto max-w-screen-2xl">
        ...
        >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-300">
                    View your affiliate withdraw requests.
                  </p>
                </div>
              </div>
          ...
          <div className="border-b border-white/10 bg-black/25 p-5 md:p-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-[220px_180px_1fr]">
              <select
                value={status}
            ...
            <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-4">
              <StatCard
                label="Page Amount"
                value={money(stats.totalAmount, currency)}
              />
              <StatCard
                label="Pending"
                value={stats.pending}
          ...
          {loading ? (
            ...
            <div className="py-20 text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Your submitted requests will show here.
              </p>
            </div>
          ) : (
            <>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-5">
                            <span
                              className={`inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-xs font-black ${chipCls(
                                rowStatus,
                              )}`}
                            >
                  ...
                  return (
                    ...
                    >
                      <div className="mb-4 flex items-start justify-between gap-4">
                        ...
                        <span
                          className={`inline-flex items-center gap-1 rounded-full border px-3 py-1 text-[11px] font-black ${chipCls(
                            rowStatus,
                          )}`}
                        >
                          {statusIcon(rowStatus)}
                      ...
                      <div className="rounded-2xl border border-white/10 bg-black/30 p-3">
                        ...
                        <p className="mt-1 text-lg font-black text-[#6fb5f4]">
                          {money(row?.amount || 0, currency)}
                        </p>
                      </div>
