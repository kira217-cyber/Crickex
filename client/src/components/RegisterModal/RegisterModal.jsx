              ...
              <div className="px-[21px] pt-6">
                ...
                <div className="mt-8">
                  ...
                  <input
                    ...
                    className="h-[45px] w-full rounded-[4px] border border-[#d7d7d7] bg-[#eeeeee] px-4 text-[13px] outline-none placeholder:text-[#8c98a3]"
                  />
                </div>
                ...
                <div className="mt-5">
                  ...
                  <div className="flex h-[45px] items-center rounded-[4px] border border-[#d7d7d7] bg-[#eeeeee] px-4">
                    <input
                      ...
                      className="h-full min-w-0 flex-1 bg-transparent text-[13px] outline-none placeholder:text-[#8c98a3]"
                    />
                  ...
                  <div ref={countryRef} className="relative">
                    <div className="flex h-[45px] items-center rounded-[4px] border border-[#d7d7d7] bg-[#eeeeee]">
                      <button
                        ...
                        className="flex h-full cursor-pointer items-center gap-2 px-4"
                      >
                        <img
                          src={selected.flag}
                          alt={selected.name}
                      ...
                      <input
                        ...
                        className="h-full min-w-0 flex-1 bg-transparent px-4 text-[13px] outline-none placeholder:text-[#8c98a3]"
                      />
                    </div>
