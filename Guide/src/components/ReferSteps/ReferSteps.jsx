...
const referSteps = [
  {
    ...
    description: {
      en: "Open the CX website or app and click on My Account.",
      bn: "CX ওয়েবসাইট বা অ্যাপ খুলে My Account-এ ক্লিক করুন।",
    },
    backColor: "#ff6400",
...
const ReferSteps = () => {
  ...
  const texts = {
    ...
    question: isBangla
      ? "CX-এ আপনার বন্ধুদের কীভাবে রেফার করবেন?"
      : "How to refer your friends in CX?",
