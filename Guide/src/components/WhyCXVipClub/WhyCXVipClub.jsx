...
const WhyCXVipClub = () => {
  ...
  const texts = {
    ...
    brand: isBangla ? "CX" : "CX",
    vipClub: isBangla ? "ভিআইপি ক্লাব?" : "VIP CLUB?",

    firstParagraph: isBangla
      ? "CX VIP Club আপনার গেমিং যাত্রাকে আরও উন্নত পর্যায়ে নিয়ে যায়। এখানে VIP সদস্যদের জন্য রয়েছে অগ্রাধিকারভিত্তিক লেনদেন, দ্রুত উইথড্র এবং শুধুমাত্র CX VIP সদস্যদের জন্য নিবেদিত ২৪/৭ ব্যক্তিগত VIP ম্যানেজার।"
      : "The CX VIP Club takes your gaming journey to the next level with priority transactions, faster withdrawals, and a 24/7 personal VIP manager dedicated only to CX VIP members.",

    secondParagraph: isBangla
      ? "আজই CX VIP Club-এ যোগ দিন এবং শুধুমাত্র আপনার জন্য তৈরি বিশেষ পুরস্কার, আকর্ষণীয় অফার ও নগদ পুরস্কার উপভোগ করুন!"
      : "Join the CX VIP Club today and enjoy exclusive rewards, exciting offers, and cash prizes designed just for you!",

    logoAlt: isBangla ? "CX ভিআইপি ক্লাব" : "CX VIP Club",
