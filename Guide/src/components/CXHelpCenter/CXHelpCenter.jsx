...
const categories = [
  {
    ...
    articles: [
      ...
      {
        id: 2,
        en: "Supported Currencies at CX",
        bn: "CX-এ সমর্থিত মুদ্রাসমূহ",
      },
      {
        id: 3,
        en: "What is CX's most recent domain?",
        bn: "CX-এর সর্বশেষ ডোমেইন কোনটি?",
      },
      {
        id: 4,
      ...
      {
        id: 6,
        en: "What is CX's policy on responsible gaming?",
        bn: "দায়িত্বশীল গেমিং সম্পর্কে CX-এর নীতি কী?",
      },
      {
        id: 7,
        en: "Can I access CX from abroad?",
        bn: "আমি কি বিদেশ থেকে CX ব্যবহার করতে পারব?",
      },
      {
        id: 8,
      ...
      {
        id: 14,
        en: "Is my personal data kept safe and secure on CX?",
        bn: "CX-এ আমার ব্যক্তিগত তথ্য কি নিরাপদে রাখা হয়?",
      },
      {
        id: 15,
      ...
      {
        id: 16,
        en: "How to download CX APP? (Android)",
        bn: "CX অ্যাপ কীভাবে ডাউনলোড করব? (Android)",
      },
      {
        id: 17,
      ...
      {
        id: 18,
        en: "Can I use the CX APP/Mobile Site with my existing username and password?",
        bn: "বর্তমান ইউজারনেম ও পাসওয়ার্ড দিয়ে কি CX অ্যাপ বা মোবাইল সাইট ব্যবহার করতে পারব?",
      },
      {
        id: 19,
        en: "Is it necessary for my registered name on CX to match my identification documents?",
        bn: "CX-এ নিবন্ধিত নাম কি পরিচয়পত্রের নামের সঙ্গে মিলতে হবে?",
      },
      {
        id: 20,
      ...
      {
        id: 21,
        en: "How to verify my CX account?",
        bn: "CX অ্যাকাউন্ট কীভাবে ভেরিফাই করব?",
      },
    ],
  },

  {
    ...
    articles: [
      {
        id: 1,
        en: "How to make a deposit on CX?",
        bn: "CX-এ কীভাবে ডিপোজিট করব?",
      },
      {
        id: 2,
      ...
      {
        id: 8,
        en: "How to withdraw money from CX?",
        bn: "CX থেকে কীভাবে টাকা উত্তোলন করব?",
      },
      {
        id: 9,
...

  {
    ...
    articles: [
      {
        id: 1,
        en: "How to get started with CX?",
        bn: "CX ব্যবহার শুরু করব কীভাবে?",
      },
      {
        id: 2,
      ...
      {
        id: 5,
        en: "How to claim CX bonuses?",
        bn: "CX বোনাস কীভাবে claim করবেন?",
      },
      {
        id: 6,
      ...
      {
        id: 8,
        en: "How to contact CX support quickly?",
        bn: "দ্রুত CX সাপোর্টে যোগাযোগ করবেন কীভাবে?",
      },
    ],
  },
...

  {
    ...
    articles: [
      {
        id: 1,
        en: "How to play casino games on CX?",
        bn: "CX-এ ক্যাসিনো গেম কীভাবে খেলব?",
      },
      {
        id: 2,
...

  {
    ...
    articles: [
      {
        id: 1,
        en: "How to claim a CX promotion?",
        bn: "CX প্রমোশন কীভাবে claim করব?",
      },
      {
        id: 2,
...

  {
    ...
    articles: [
      {
        id: 1,
        en: "Why is the CX website not loading?",
        bn: "CX ওয়েবসাইট load হচ্ছে না কেন?",
      },
      {
        id: 2,
      ...
      {
        id: 6,
        en: "Which browsers are supported by CX?",
        bn: "CX কোন browser সমর্থন করে?",
      },
      {
        id: 7,
        en: "How to update the CX mobile app?",
        bn: "CX মোবাইল অ্যাপ কীভাবে update করব?",
      },
      {
        id: 8,
