...
const ContactUs = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      paragraphs: [
        {
          en: "Our support team is available 24/7 through live chat on the CX website and app to assist you with any issue, any time.",
          bn: "CX ওয়েবসাইট ও অ্যাপে লাইভ চ্যাটের মাধ্যমে আমাদের সাপোর্ট টিম ২৪/৭ আপনার যেকোনো সমস্যার সমাধানে প্রস্তুত।",
        },
      ],
    },
    {
