  ...
  const sections = [
    {
      paragraphs: [
        {
          en: "CX respects your privacy and is committed to protecting your personal information. This policy explains what information we collect, how we use it, and how we keep it safe.",
          bn: "CX আপনার প্রাইভেসিকে গুরুত্ব দেয় এবং আপনার ব্যক্তিগত তথ্য সুরক্ষিত রাখতে প্রতিশ্রুতিবদ্ধ। এই পলিসিতে আমরা কী তথ্য সংগ্রহ করি, কীভাবে তা ব্যবহার করি এবং কীভাবে নিরাপদ রাখি তা ব্যাখ্যা করা হয়েছে।",
        },
      ],
    },
    {
