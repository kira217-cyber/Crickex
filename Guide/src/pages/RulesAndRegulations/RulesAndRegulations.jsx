  ...
  const sections = [
    {
      paragraphs: [
        {
          en: "By creating an account and using CX, you agree to follow the rules and regulations described below, along with our Terms and Conditions and Privacy Policy.",
          bn: "একটি অ্যাকাউন্ট তৈরি করে CX ব্যবহার করার মাধ্যমে, আপনি নিচে উল্লেখিত নিয়মাবলী এবং আমাদের শর্তাবলী ও প্রাইভেসি পলিসি মেনে চলতে সম্মত হচ্ছেন।",
        },
      ],
    },
    {
