  ...
  const sections = [
    {
      paragraphs: [
        {
          en: "CX is committed to promoting responsible gambling. While gaming is meant to be fun and entertaining, we want every player to stay in control of their time and spending.",
          bn: "CX দায়িত্বশীল গেমিং প্রচারে প্রতিশ্রুতিবদ্ধ। গেমিং আনন্দ ও বিনোদনের জন্য হলেও, আমরা চাই প্রতিটি খেলোয়াড় তাদের সময় ও খরচের ওপর নিয়ন্ত্রণ বজায় রাখুক।",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        {
          en: "CX services are strictly intended for adults who meet the legal age requirement in their jurisdiction. Gambling by minors is strictly prohibited.",
          bn: "CX-এর সেবা শুধুমাত্র তাদের জন্য, যারা তাদের অঞ্চলের আইনি বয়সসীমা পূরণ করেন। অপ্রাপ্তবয়স্কদের গেমিং কঠোরভাবে নিষিদ্ধ।",
        },
      ],
    },
    {
