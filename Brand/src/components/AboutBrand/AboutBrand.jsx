...
const AboutBrand = () => {
  ...
  const paragraphs = isBangla
    ? [
        "CX একটি বিনোদনভিত্তিক প্ল্যাটফর্ম যা তার ব্যবহারকারীদের জন্য একটি নিরাপদ, দ্রুত এবং উপভোগ্য অভিজ্ঞতা তৈরি করতে প্রতিশ্রুতিবদ্ধ।",
    ...
    : [
        "CX is an entertainment-focused platform committed to building a safe, fast, and enjoyable experience for its users.",
