    ...
    <section className="relative w-full overflow-hidden bg-[#071128]">
      ...
      <div className="relative hidden min-h-[935px] w-full lg:block xl:min-h-[985px]">
        ...
        <div className="absolute inset-0 mx-auto w-full max-w-auto">
          ...
          >
            {isBangla
              ? "“CX পরিবারের ব্র্যান্ড অ্যাম্বাসেডর হিসেবে যোগ দিতে পেরে আমি সত্যিই সম্মানিত ও আনন্দিত। এই ব্র্যান্ড খেলাধুলা এবং বিনোদনের মাধ্যমে লক্ষ লক্ষ মানুষের সঙ্গে সংযোগ তৈরি করে। ভক্ত ও খেলোয়াড়দের জন্য স্মরণীয় অভিজ্ঞতা তৈরি করার অপেক্ষায় আছি। এই অংশীদারত্ব একটি রোমাঞ্চকর যাত্রার শুরু মাত্র!”"
              : "“I am truly honored and excited to join the CX family as their brand ambassador. It’s a brand that connects millions through sports and entertainment. I look forward to creating memorable experiences for fans & players. This partnership is just the beginning of an exciting journey ahead!”"}
          </motion.blockquote>
        ...
        <div className="relative bg-[#071128] px-6 py-9 text-center sm:px-12 sm:py-11">
          ...
          >
            {isBangla
              ...
              : "“I am truly honored and excited to join the CX family as their brand ambassador. I look forward to creating memorable experiences for fans and players. This partnership is just the beginning of an exciting journey ahead!”"}
          </blockquote>
        </div>
